 ...
 * 
 */
 package fr.amapj.view.views.permanence.detailperiode.grille;
 ...
 *
 */
public class ModifierInscriptionGrillePart extends AbstractPeriodePermanenceGrillePart
{

	public ModifierInscriptionGrillePart(Long idPeriodePermanence)
	{
	...
	{
		PopupModifPermanence.open(new PopupModifPermanence(date.idPeriodePermanenceDate),this);
	}
