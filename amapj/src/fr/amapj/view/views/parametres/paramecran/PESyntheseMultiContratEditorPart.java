...
/**
 * Permet la saisie des paramètres de l'écran "synthese multi contrat"
 * 
 */
public class PESyntheseMultiContratEditorPart extends WizardFormPopup
{
	private PESyntheseMultiContrat pe;

	public enum Step
	{
		IMPRESSION_MENSUEL ,IMPRESSION_TRIMESTRE ;
	}

	/**
	 * 
	 */
	public PESyntheseMultiContratEditorPart()
	{
		...
		item = new BeanItem<PESyntheseMultiContrat>(this.pe);
