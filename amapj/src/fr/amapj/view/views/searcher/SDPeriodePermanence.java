...
public class SDPeriodePermanence implements SearcherDefinition
{
	@Override
	public String getTitle()
	{
		return "Période de permanence";
	}

	@Override
	public List<? extends Identifiable> getAllElements(Object params)
	{
		return new SearcherService().getAllElements(PeriodePermanence.class);
	}
	...
	{
		PeriodePermanence u = (PeriodePermanence) identifiable;
		return u.nom;
	}
