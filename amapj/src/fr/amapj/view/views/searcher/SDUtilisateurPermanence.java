...
/**
 * Permet de modifier les utilisateurs d'une permanence  
 * 
 */
public class SDUtilisateurPermanence implements SearcherDefinition
{
	
	private List<Utilisateur> allowed;
	
	public SDUtilisateurPermanence(List<Utilisateur> allowed)
	{
